...
<Callout type="warning" emoji="⚠️">
  This is not official documentation for any [PrismarineJS](https://prismarinejs.github.io/) project, and it shouldn't be treated that way. This is an attempt at a more beginner-friendly guide/documentation/script by [Pix3lPirat3](https://github.com/Pix3lPirat3).
</Callout>
